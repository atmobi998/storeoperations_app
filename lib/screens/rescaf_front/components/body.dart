...
import 'package:storeoperations_app/screens/rescaf_front/components/product_list.dart';

class ResCafFrontMainBody extends StatefulWidget {

  const ResCafFrontMainBody({Key? key}) : super(key: key);

  @override
  _ResCafFrontMainBody createState() => _ResCafFrontMainBody();

}

class _ResCafFrontMainBody extends State<ResCafFrontMainBody> with AfterLayoutMixin<ResCafFrontMainBody> {
...
void initState() {
                      ...
                      child: ConstrainedBox(
                        ...
                        child: Row(
                          children: [
                              ...
                              Column(
                                children: <Widget>[
                                  Text(txtFrontTitle,style: TextStyle(fontSize: getProportionateScreenWidth(18),color: kPrimaryColor,fontWeight: FontWeight.bold)),
  ...
  checkoutOrder() {
    var postdata = {
        ...
        "rescaf_checkout" : "1",
        "rescafcheckout_log" : DateTime.now().toIso8601String(),
        "status" : "Checked out at "+DateTime.now().toIso8601String(),
        "created" : dateDbFormat.format(DateTime.now()), "time" : dateDbFormat.format(DateTime.now()),
      };
    var posthdr = {
        'Accept': 'application/json',
