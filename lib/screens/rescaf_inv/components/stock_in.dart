...
class StockInBody extends StatefulWidget {

  const StockInBody({Key? key}) : super(key: key);

  @override
  _StockInBody createState() => _StockInBody();

}

class _StockInBody extends State<StockInBody> with AfterLayoutMixin<StockInBody> {
    ...
    return Container(
      ...
      child: ConstrainedBox(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(counterText: ' ', counterStyle: const TextStyle(fontSize: 0), helperStyle: const TextStyle(fontSize: 0), errorStyle: const TextStyle(fontSize: 0),
            labelText: lblResCafStkInCommentText,
            hintText: hintResCafStkInCommentText,
            floatingLabelBehavior: FloatingLabelBehavior.always,
            suffixIcon: const CustomSurffixIcon(svgIcon: "assets/icons/TextIcon.svg"),
          ),
        ),
