...
class RetailPosMainBody extends StatefulWidget {

  const RetailPosMainBody({Key? key}) : super(key: key);

  @override
  _RetailPosMainBody createState() => _RetailPosMainBody();

}

class _RetailPosMainBody extends State<RetailPosMainBody> with AfterLayoutMixin<RetailPosMainBody> {
  ...
  tktSaveChanges(tsesidx,Ticket tsestkt) {
    ...
    var postdata = {
        ...
        "time" : dateDbFormat.format(DateTime.now()),
      };
    var posthdr = {
        'Accept': 'application/json',
        'Authorization' : 'Bearer $usertoken'
