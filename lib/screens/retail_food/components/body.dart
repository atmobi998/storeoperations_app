...
class RetailFoodMainBody extends StatefulWidget {

  const RetailFoodMainBody({Key? key}) : super(key: key);

  @override
  _RetailFoodMainBody createState() => _RetailFoodMainBody();

}

class _RetailFoodMainBody extends State<RetailFoodMainBody> with AfterLayoutMixin<RetailFoodMainBody> {
                        ...
                        child: ConstrainedBox(
                          ...
                          child: Row(
                            children: [
                                ...
                                Column(
                                  children: <Widget>[
                                    Text(txtRetailFoodTitle,style: TextStyle(fontSize: getProportionateScreenWidth(39),color: kPrimaryColor,fontWeight: FontWeight.bold,),),
