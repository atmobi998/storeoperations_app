...
class RetailFrontMainBody extends StatefulWidget {

  const RetailFrontMainBody({Key? key}) : super(key: key);

  @override
  _RetailFrontMainBody createState() => _RetailFrontMainBody();

}

class _RetailFrontMainBody extends State<RetailFrontMainBody> with AfterLayoutMixin<RetailFrontMainBody> {
                        ...
                        child: ConstrainedBox(
                          ...
                          child: Row(
                            children: [
                                ...
                                Column(
                                  children: <Widget>[
                                    Text(txtRetailFrontTitle,style: TextStyle(fontSize: getProportionateScreenWidth(39),color: kPrimaryColor,fontWeight: FontWeight.bold,),),
