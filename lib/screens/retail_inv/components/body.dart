...
class RetailInvMainBody extends StatefulWidget {

  const RetailInvMainBody({Key? key}) : super(key: key);

  @override
  _RetailInvMainBody createState() => _RetailInvMainBody();

}

class _RetailInvMainBody extends State<RetailInvMainBody> with AfterLayoutMixin<RetailInvMainBody> {
                        ...
                        child: ConstrainedBox(
                          ...
                          child: Row(
                            children: [
                                ...
                                Column(
                                  children: <Widget>[
                                    Text(txtRetailInvTitle,style: TextStyle(fontSize: getProportionateScreenWidth(39),color: kPrimaryColor,fontWeight: FontWeight.bold,),),
